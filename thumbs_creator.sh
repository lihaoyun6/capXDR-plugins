...
case $file in
	p|P)
		...
		do
			...
			pluginName=${i%.*}
			echo '<a href="https://cdn.jsdelivr.net/gh/lihaoyun6/capXDR-plugins/plugins/'$pluginName'.zip"><img src="https://cdn.jsdelivr.net/gh/lihaoyun6/capXDR-plugins/thumbs/'$pluginName'.jpg" alt="'$pluginName'" height="128" /></a>' >> ../thumbs/thumbs.md
